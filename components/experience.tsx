        ...
        <div className="flex flex-col md:flex-row gap-16 items-center mb-40">
          <div className="w-full md:w-1/2">
            <motion.div 
              ...
              className="relative"
            >
              <div className="inline-block px-3 py-1 rounded-md bg-blue-500/10 border border-blue-500/20 mb-6">
        ...
        <div className="flex flex-col md:flex-row-reverse gap-16 items-center">
          <div className="w-full md:w-1/2 text-right">
            ...
            >
              ...
              <p className="mt-8 text-lg text-slate-400 leading-relaxed ml-auto max-w-md">
